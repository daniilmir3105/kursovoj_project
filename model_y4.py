...
y = data.World_oil_production_in_the_t_th_year_in_billion_cubic_meters

X = data.drop(['Index', 'Year', 'World_oil_production_in_the_t_th_year_in_billion_cubic_meters'], axis=1)
...
if __name__ == '__main__':
    ...
    print('Predictions are: ' + str(model_y4.predict(X.head())))
